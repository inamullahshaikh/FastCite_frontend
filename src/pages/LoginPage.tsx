...
import logo from "../assets/logo.png"; // Assuming same path as SignupPage
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Your backend's /auth/login uses OAuth2PasswordRequestForm,
    // which expects 'application/x-www-form-urlencoded' data, not JSON.
    ...
    try {
      const response = await fetch(`${BACKEND_URL}/auth/login`, {
        ...
        body: formBody.toString(), // Convert URLSearchParams to a string
      });

      const data = await response.json();

      if (!response.ok) {
        throw new Error(data.detail || 'Login failed. Check username or password.');
      }
      ...
      // Redirect to the main app page (e.g., dashboard or home)
      // You can change '/' to your app's main route
  ...
  const handleGoogleLogin = () => {
    // This function is identical to the one in SignupPage
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="w-full max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            {/* Left Side - Illustration (Identical to Signup) */}
            <div className="hidden lg:flex flex-col justify-center space-y-8">
              ...
              {/* Illustration SVG (Identical to Signup) */}
              ...
              <div className="bg-[var(--color-surface-primary)] rounded-2xl border border-[var(--color-border-primary)] p-6 sm:p-8 shadow-2xl">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Username Input (Backend expects 'username') */}
                    <div className="space-y-2">
